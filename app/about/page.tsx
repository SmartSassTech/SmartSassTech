    ...
    return (
        <div className="bg-kb-bg min-h-screen py-16 md:py-24">
            <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
                <h1 className="text-4xl md:text-5xl font-heading font-medium text-sst-primary text-center mb-12 tracking-tight">
                    About SmartSass Tech
                </h1>

                <div className="bg-white p-8 md:p-12 rounded-3xl shadow-xl leading-relaxed">
                    <h2 className="text-2xl md:text-3xl font-bold text-sst-primary mb-6">Patient, Jargon-Free Support</h2>
                    ...
                    <h3 className="text-xl font-bold text-sst-primary mb-4">Our Approach</h3>
                    ...
                    <h3 className="text-xl font-bold text-sst-primary mb-4">What We Help With</h3>
                    ...
                    <h3 className="text-xl font-bold text-sst-primary mb-4">Why Choose Us?</h3>
                    ...
                    <div className="text-center pt-12 border-t border-kb-cream">
                        <h3 className="text-2xl font-bold text-sst-primary mb-4">Ready to Get Started?</h3>
