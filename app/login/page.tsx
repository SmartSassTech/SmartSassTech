        ...
        try {
            if (isLogin) {
                ...
                if (error) {
                    ...
                    setMessage({ text: 'Sign up successful! Please check your email for a confirmation link.', type: 'success' })
                }
            }
        } catch (err) {
            ...
            <div className="max-w-md w-full bg-white p-10 rounded-[2rem] shadow-2xl space-y-8">
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <button
                        type="submit"
                        disabled={isLoading}
                        className={`w-full py-5 bg-sst-primary text-white font-bold rounded-2xl hover:bg-sst-secondary transition-all shadow-xl text-lg flex items-center justify-center
