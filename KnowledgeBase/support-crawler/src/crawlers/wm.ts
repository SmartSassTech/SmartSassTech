...
export class WMCrawler extends BaseCrawler {
    company = 'WM';
    baseUrl = 'https://www.wm.com';
    sitemapUrl = 'https://www.wm.com/support-articles-sitemap.xml';
    ...
    extract(url: string, html: string): Article {
        ...
        return {
            ...
            category: 'Support',
            productService: 'Waste Management',
